...
def create_yolov3_modules(config_model, ignore_thre):
    ...
    # ResNet50 combination with Darknet53
    mlist.append(add_conv(in_ch=3, out_ch=32, ksize=3, stride=2))
    mlist.append(add_conv(in_ch=32, out_ch=64, ksize=3, stride=1))
    mlist.append(resblock(ch=64))
...
#Resnet bacbone from pytorch  above but written out in pytorch 
# (Error: ValueError: expected 4D input (got 3D input))
    ...
    #nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    #mlist.append(add_conv(in_ch=64, out_ch=64, ksize=3, stride=2))
    #nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    #mlist.append(add_conv(in_ch=64, out_ch=256, ksize=1, stride=2))
    #nn.BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    #nn.ReLU(inplace=True)
    #mlist.append(add_conv(in_ch=256, out_ch=64, ksize=1, stride=2))
    #mlist.append(add_conv(in_ch=64, out_ch=256, ksize=1, stride=2))
    #nn.BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    #mlist.append(add_conv(in_ch=256, out_ch=64, ksize=1, stride=2))
    #nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    ...
    #nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    #mlist.append(add_conv(in_ch=64, out_ch=256, ksize=1, stride=2))
    #nn.AdaptiveAvgPool2d(output_size=1024)
    #nn.Linear(in_features=2048, out_features=1000, bias=True)
    #mlist.append(add_conv(in_ch=256, out_ch=1024, ksize=1, stride=2))
    ...
    mlist.append(add_conv(in_ch=1, out_ch=256, ksize=1, stride=1))
